  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-6">
      <div className="flex flex-col md:flex-row gap-6 max-w-6xl mx-auto">
        {/* Profile Section */}
        <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-1/3 transform transition-transform duration-300 hover:scale-105">
        ...
        {/* Orders Section */}
        <div className="bg-white shadow-lg rounded-lg p-6 w-full md:w-2/3 transform transition-transform duration-300 hover:scale-105">
